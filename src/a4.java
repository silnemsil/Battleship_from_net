/**
 * Created by opilane on 27.10.2016.
 */
import java.util.*;
    ...
    public static void main( String args[] )
    {
        ...
        while((count1 < 17) || (count2 < 17))
        {
            ...
            if(player == 1)
            {
                ...
                System.out.print("\nSisesta täht a-st kuni k-ni veeru jaoks ja vajuta enter, seejärel sisesta number 1st  10ni rea jaoks ja vajuta uuesti enter \nrespectively for the quardents of your shot: ");
                ...
                if( b == 0)
                {
                                        ...
                                        for(l = 1; l<=10; l++)
                                        {
                                            if((a1[k][l] == 1) && (g1[k][l] ==2))
                                            {
                                                ...
                                                if(e.getHit() == e.getSize())
                                                    System.out.print("sa uputasid mu laeva : " + e.getName() + "\n");
                                                else
                                                    System.out.print("\n\nMängija 1 tabas laeva\n");
                    ...
                    System.out.println("Oled sinna juba tulistanud");
